...
export default function TableWarehouseCloseStock({
  apiKey,
  formData,
  setFormData,
  autoId,
  ...
  const handleAutocompleteChange = (event, newValue) => {
    ...
    updatedFormData[Index].Bin = 0;
    updatedFormData[Index].BinName = "";
  ...
  const fetchOptions = async (searchKey) => {
    ...
    if(!beId){
      ...
      updatedFormData[Index].Bin = 0;
      updatedFormData[Index].Bin_Name = "";
      setFormData(updatedFormData);
  ...
  const debouncedFetchOptions = useCallback(debounce(fetchOptions, 300), [beId, iTypeF2]);
