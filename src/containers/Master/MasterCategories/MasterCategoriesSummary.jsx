...
export default function MasterCategoriesSummary({
  setPageRender,
  setId,
  userAction,
  setGroup,
  ...
  const { GetCategorySummary, deleteCategory, updateproductproperties, gettagurl } =
    masterApis();
  ...
  const handledeleteRole = async () => {
    ...
    try {
      let response = await deleteCategory(deletePayload);
