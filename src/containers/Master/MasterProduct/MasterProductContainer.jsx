...
import MasterProductSummary from "./MasterProductSummary";
import MasterProductDetails from "./MasterProductDetails";

export default function MasterProductContainer() {
