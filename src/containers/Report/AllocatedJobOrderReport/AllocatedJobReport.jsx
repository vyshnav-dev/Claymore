...
export default function AllocatedJobReport({ userAction, disabledDetailed }) {
    ...
    const { getallocatedjoborderreport } = reportApis();
    useEffect(() => {
    ...
    const tagDetails = async () => {
        ...
        try {
            if (
                ...
                const response = await getallocatedjoborderreport({
